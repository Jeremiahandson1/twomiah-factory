...
// Width is not part of the look — see invoicing/ui.tsx: appending `w-auto` to a w-full class does nothing,
// because Tailwind emits .w-full after .w-auto. selectCls is the content-sized variant. (Vet T12 M1)
const portalControlCls = 'px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white text-gray-900 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-100'
export const inputCls = `w-full ${portalControlCls}`
export const selectCls = `w-auto ${portalControlCls}`
