...
initFile(homepageFile, {
  hero: {
    tagline: 'Trusted general_contractor',
    title: 'Jeremiah',
    subtitle: 'Professional general_contractor Services',
    description: 'Serving the EC with Quality & Professionalism',
    image: '',
    animation: 'none',
  ...
  ctaSection: {
    ...
    primaryButtonLink: '#contact',
    secondaryButtonText: 'Call 5555555555',
    secondaryButtonLink: 'tel:5555555555',
    backgroundImage: ''
  },
  serviceAreas: ['EC', 'Nearby City 1', 'Nearby City 2', 'Nearby City 3', 'Nearby City 4'],
  businessHours: {
...
<p>Jeremiah has been proudly serving the EC with professional general_contractor services.</p>
...
<p><strong>Licensed &amp; Insured</strong> - Full protection for your peace of mind.</p>`,
    heroDescription: 'Learn about Jeremiah and our commitment to quality.',
...
<p>We serve EC and the surrounding EC area.</p>
...
if (!fs.existsSync(settingsFile)) {
  const defaultPassword = bcrypt.hashSync('bMDER9jk!', 10);
  fs.writeFileSync(settingsFile, JSON.stringify({
    adminPassword: defaultPassword,
    siteName: 'Jeremiah',
    companyName: 'Jeremiah LLC',
    phone: '5555555555',
    ...
    defaultMetaTitle: 'Jeremiah - general_contractor Services in EC',
    defaultMetaDescription: 'Professional general_contractor services in the EC. Contact us today for a free estimate.',
    analytics: {
      googleAnalyticsId: '',
      facebookPixelId: '',
      googleTagManagerId: ''
...
Sitemap: https://test@test.com/sitemap.xml`,
    emailNotifications: {
      enabled: false,
      recipient: 'jeremiahandson@gmail.com',
      smtpHost: '',
      smtpPort: 587,
      smtpUser: '',
      smtpPass: '',
      fromEmail: 'noreply@test@test.com',
      fromName: 'Jeremiah Website',
      sendgridApiKey: ''
    },
...
router.post('/2fa/setup', authMiddleware, (req, res) => {
  try {
    ...
    const otpauthUrl = `otpauth://totp/JeremiahAdmin?secret=${secret}&issuer=Jeremiah`;
...
router.get('/sitemap.xml', (req, res) => {
  try {
    ...
    const baseUrl = process.env.SITE_URL || 'https://test@test.com';
...
router.post('/posts', authMiddleware, (req, res) => {
  try {
    ...
    const newPost = {
      ...
      author: req.body.author || 'Jeremiah',
