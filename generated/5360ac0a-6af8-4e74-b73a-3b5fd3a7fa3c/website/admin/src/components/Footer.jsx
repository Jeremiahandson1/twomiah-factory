  ...
  return (
    <footer className="main-footer">
        ...
        <div className="container">
          <div className="footer-grid">
            <div className="footer-col about-col">
              ...
              <p>Quality services for customers throughout the EC area. Licensed, insured, and committed to excellence.</p>
      ...
      <div className="footer-bottom">
        <div className="container">
          <p>&copy; {currentYear} Jeremiah. All rights reserved.</p>
          <p>Serving EC, Nearby City 4, Nearby City 1, and the EC</p>
        </div>
      </div>
    </footer>
  );
