    ...
    <div className="service-page">
        ...
        <div className="service-hero-content">
          <div className="container">
            ...
            <div className="hero-buttons">
              ...
              <a href="tel:5555555555" className="btn btn-outline-light btn-lg">
          ...
          <div className="service-layout">
            ...
            <aside className="service-sidebar">
              <div className="cta-card">
                ...
                <a href="tel:5555555555" className="phone-link">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
                  </svg>
                  5555555555
      ...
      <section className="service-cta">
        <div className="container">
          ...
          <p>Contact Jeremiah today for a free estimate. We serve EC and the surrounding EC area.</p>
          <div className="cta-buttons">
            <Link to="/#contact" className="btn btn-primary btn-lg">Get Free Estimate</Link>
            <a href="tel:5555555555" className="btn btn-outline-light btn-lg">Call 5555555555</a>
          </div>
        </div>
      </section>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "provider": {
          ...
          "areaServed": { "@type": "City", "name": "EC, ST" }
        },
        "areaServed": ["EC", "Nearby City 4", "Nearby City 1", "Nearby City 2", "Nearby City 3"].map(city => ({
          "@type": "City",
          "name": city + ", WI"
        })),
