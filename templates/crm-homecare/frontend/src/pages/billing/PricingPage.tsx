...
export default function PricingPage() {
  ...
  const loadPricing = async () => {
    try {
      // Care mounts subscription routes at /api/subscription (not /api/billing,
      // which is reserved for per-client invoice billing in this template).
      const data = await api.get('/api/subscription/pricing');
      setPricing(data);
    } catch (error) {
