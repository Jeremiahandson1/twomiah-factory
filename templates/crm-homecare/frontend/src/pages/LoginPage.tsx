...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-slate-800">
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-sm dark:bg-slate-900">
        {/* Logo area */}
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-bold text-gray-900 dark:text-slate-100">{{COMPANY_NAME}}</h1>
          <p className="text-sm text-gray-500 mt-1 dark:text-slate-400">Home Care Management</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 dark:border-slate-700"
