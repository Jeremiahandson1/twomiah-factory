...
const SAAS_TIERS: SaaSTier[] = [
  {
    ...
    annual: 490,
    bundledWebsite: null,
    heroFeatures: ['Client & caregiver records', 'Visit scheduling', 'Time tracking & EVV', 'Basic invoicing', 'Caregiver mobile app'],
  ...
  },
  {
    ...
    heroFeatures: ['Private-pay rate engine', 'Care types & rates', 'Caregiver bio pages', 'Family portal', 'Showcase website included'],
  ...
  },
  {
    id: 'agency',
    name: 'Agency',
    tagline: 'Full claims + multi-branch + caregiver portal',
    description: 'Full home care agency operations platform',
    monthly: 599,
    annual: 5990,
    bundledWebsite: 'book_jobs',
