...
export const SAAS_TIERS = {
  ...
  agency: {
    ...
    // to mint the dedicated Agency SKU. Both are $599/mo so price is unchanged.
    stripePriceId: process.env.STRIPE_PRICE_AGENCY || process.env.STRIPE_PRICE_CONSTRUCTION,
    stripePriceIdAnnual: process.env.STRIPE_PRICE_AGENCY_ANNUAL || process.env.STRIPE_PRICE_CONSTRUCTION_ANNUAL,
    features: [
...
export const SELF_HOSTED_PACKAGES = {
  starter: {
    ...
    description: 'Core home care CRM for self-hosting',
  ...
  pro: {
    id: 'pro',
    name: 'Pro License',
    description: 'Private-pay billing + Showcase website for self-hosting',
  ...
  business: {
    ...
    description: 'Medicare/Medicaid claims platform for self-hosting',
...
export const FEATURE_BUNDLES = {
  ...
  // /api/ads. For home care agencies, drives referral source advertising
  // and family-direct campaigns.
  twomiah_ads: {
    id: 'twomiah_ads',
    name: 'Twomiah Ads',
    description: 'Automated Google + Meta ads for home care referrals',
    price: 9900,
    interval: 'month',
    ...
    subFeatures: {
      ...
      campaign_management: { name: 'Referral + family campaigns', price: 1500 },
