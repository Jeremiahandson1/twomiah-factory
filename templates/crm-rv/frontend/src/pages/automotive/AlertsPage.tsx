      ...
      {loading ? (
        ...
        <div style={{ textAlign: 'center', padding: 60, color: '#9ca3af' }}>
          ...
          <p style={{ fontSize: 14, marginTop: 4 }}>
            When a customer with an active sales lead brings a unit into service, you'll see it here.
          </p>
        </div>
      ) : (
          ...
          {alerts.map((alert: any) => (
            ...
            >
              ...
              <div style={{ display: 'flex', gap: 16, fontSize: 13, color: '#6b7280', marginBottom: 12 }}>
                ...
                {(alert.unitInterest || alert.vehicleInterest) && <span>Interested in: {alert.unitInterest || alert.vehicleInterest}</span>}
              </div>
