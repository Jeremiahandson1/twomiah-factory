    ...
    <div className="max-w-5xl mx-auto p-6">
      <div className="flex items-center gap-3 mb-1">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-slate-400">Flat-rate service operations — standard hours × your shop rate{rate ? ` ($${rate}/hr)` : ''}.</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border shadow-sm p-4 mt-4 flex flex-wrap gap-3 items-end dark:bg-slate-900">
        <div className="flex-1 min-w-[220px]">
          <label className="text-xs font-medium text-gray-600 dark:text-slate-400">Search operations</label>
      ...
      <div className="mt-4 bg-white rounded-xl border shadow-sm overflow-hidden dark:bg-slate-900">
        <div className="px-4 py-2.5 border-b text-sm font-semibold text-gray-600 dark:text-slate-400">{ops.length} operation{ops.length === 1 ? '' : 's'}</div>
