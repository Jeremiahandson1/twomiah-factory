...
export default function AITradeAppraisalPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      ...
      <div className="bg-white rounded-xl border shadow-sm p-4 mt-5 grid grid-cols-2 md:grid-cols-3 gap-3 dark:bg-slate-900">
        <label className="text-xs font-medium text-gray-600 dark:text-slate-400">Year
        ...
        <label className="text-xs font-medium text-gray-600 dark:text-slate-400">Make
        ...
        <label className="text-xs font-medium text-gray-600 dark:text-slate-400">Model
        ...
        <label className="text-xs font-medium text-gray-600 dark:text-slate-400">Category
        ...
        <label className="text-xs font-medium text-gray-600 dark:text-slate-400">Miles / Hours
      ...
      {res && (
        <div className="mt-5 space-y-4">
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="bg-white rounded-xl border shadow-sm p-5 dark:bg-slate-900">
              <div className="text-xs uppercase tracking-wide text-gray-500 mb-1 dark:text-slate-400">Est. retail</div>
              <div className="text-3xl font-bold text-gray-800 dark:text-slate-200">{money(res.appraisal?.retail?.low)} – {money(res.appraisal?.retail?.high)}</div>
            </div>
          </div>
          <div className="bg-white rounded-xl border shadow-sm p-5 text-sm text-gray-700 space-y-2 dark:bg-slate-900 dark:text-slate-200">
