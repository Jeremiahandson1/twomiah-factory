...
interface Integration {
  ...
  label: string;
  description: string;
  category: 'lead_sources' | 'accounting' | 'dns' | 'communication' | 'payments';
  guideSteps: string[];
  externalUrl?: string;
...
const INTEGRATIONS: Integration[] = [
  ...
  {
    id: 'dms_import',
    label: 'Existing DMS / Spreadsheet',
    description: 'Import your existing inventory, customers, and deals from your current DMS or a CSV.',
    category: 'accounting',
    guideSteps: [
      'Export your data (Inventory, Customers, Deals) as CSV from your current system',
  ...
  },
  {
    id: 'rv_trader',
    label: 'RV Trader',
    description: 'Automatically pull RV Trader leads into your CRM lead inbox.',
    category: 'lead_sources',
    guideSteps: [
      'Go to Settings > Integrations > Lead Sources in your CRM',
      'Click "Connect RV Trader" and enter your RV Trader dealer account details',
      'New leads will automatically flow into your Lead Inbox',
      'Set up auto-reply templates to respond to shoppers instantly',
    ],
  },
  {
    id: 'cycle_trader',
    label: 'Cycle Trader',
    description: 'Pull Cycle Trader / powersports leads directly into your CRM.',
    category: 'lead_sources',
    guideSteps: [
      'Go to Settings > Integrations > Lead Sources',
      'Click "Connect Cycle Trader" and authenticate with your dealer account',
      'Choose which listings to route leads from',
      'Leads will appear in your Lead Inbox automatically',
    ],
  },
  {
    id: 'dealer_spike',
    label: 'Dealer Spike / DX1',
    description: 'Route website and marketplace leads from your dealer website provider.',
    category: 'lead_sources',
    guideSteps: [
      'Go to Settings > Integrations > Lead Sources',
      'Add your Dealer Spike / DX1 lead-forwarding email or webhook',
      'Point your website provider’s lead notifications to it',
      'New website leads will appear in your Lead Inbox',
    ],
  },
  {
    id: 'stripe',
  ...
  },
  {
    ...
    description: 'Send and receive SMS with customers directly from your CRM.',
    ...
    guideSteps: [
      ...
      'Once connected, you can text customers from any contact or job page',
    ],
  },
];
...
const CATEGORY_LABELS: Record<string, string> = {
  ...
  accounting: 'Accounting & Import',
  payments: 'Payments',
  communication: 'Communication',
};

const CATEGORY_ORDER = ['dns', 'lead_sources', 'accounting', 'payments', 'communication'];
...
export default function OnboardingWizard() {
  ...
  // email otherwise poisons the final save (server 400) and loses everything. (ONB-01)
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-orange-50 dark:from-slate-950 dark:to-slate-900 flex flex-col">
      ...
      <div className="flex-1 flex items-start justify-center px-4 py-8">
        <div className="w-full max-w-2xl">
          ...
          {currentStep === 2 && <EmailAliasesStep productId="crm-rv" defaultForwardTo={profile.email} onBack={handleBack} onNext={handleNext} />}
