...
async function main() {
  ...
  if (existingArticles.length === 0) {
    ...
    const helpArticles = [
      { title: 'Getting Started', content: 'Welcome! Start by adding your unit inventory and contacts, then work deals from lead to delivery. Use the sidebar to move between modules.', category: 'Getting Started', isFaq: true, sortOrder: 1 },
      { title: 'Managing Inventory', content: 'Add new and used units to Inventory with pricing and specs. Units can be attached to deals and marked sold when they move.', category: 'Inventory', isFaq: true, sortOrder: 2 },
      { title: 'Contacts & Leads', content: 'Capture leads and customers in Contacts. Each contact can have multiple deals, service visits and documents linked to them.', category: 'Getting Started', isFaq: false, sortOrder: 3 },
      { title: 'Working Deals', content: 'Create a deal for a contact and a unit, add F&I products and trade-in details, and move it through the pipeline to Sold and Delivered.', category: 'Sales', isFaq: false, sortOrder: 4 },
      { title: 'Service & Parts', content: 'Open service ROs from the Service page and sell parts and accessories. Link service to a unit and customer for full history.', category: 'Service', isFaq: false, sortOrder: 5 },
      { title: 'Invoices & Payments', content: 'Create invoices for sales, service and parts, add line items, and record payment. Track outstanding balances.', category: 'Billing', isFaq: false, sortOrder: 6 },
    ]
  ...
  const DEFAULT_CATEGORIES = ['New Units', 'Used Units', 'Service', 'Parts & Accessories', 'Financing & F&I']
  const DEFAULT_STATUSES = ['Lead', 'Quoted', 'Negotiating', 'Sold', 'Delivered', 'Lost']
