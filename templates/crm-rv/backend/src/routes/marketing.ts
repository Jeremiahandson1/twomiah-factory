...
// Here the same page is also the Follow-Up product (follow_up_sequences): either switch keeps it open.
export default createMarketingRoutes({ service: marketing, authenticate, requirePermission, escapeHtml, featureGate: requireEnabledFeature(['email_marketing', 'follow_up_sequences']) })
