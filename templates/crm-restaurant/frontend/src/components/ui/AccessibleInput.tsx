...
const AccessibleInput = forwardRef<HTMLInputElement, any>(({
  label,
  error,
  helperText,
  required = false,
  ...
  return (
    <div className={containerClassName}>
      ...
      <div className="relative">
        {LeftIcon && (
          <div className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 dark:text-slate-400" aria-hidden="true">
