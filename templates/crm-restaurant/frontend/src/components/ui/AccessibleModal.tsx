    ...
    >
      ...
      <div className="flex justify-end gap-3">
        <button
          ...
          onClick={onClose}
          disabled={loading}
          className="px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-gray-400 dark:text-slate-200"
        >
          {cancelText}
        </button>
        <button
