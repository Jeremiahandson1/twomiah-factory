    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={openPdf} className="px-4 py-2 bg-gray-100 rounded-lg hover:bg-gray-200 flex items-center gap-2 dark:bg-slate-800">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-lg shadow-sm p-6">
              ...
              <div className="border border-green-200 rounded-lg bg-green-50 p-4">
                ...
                {quote.signedUserAgent ? (
                  <p className="mt-1 text-xs text-gray-400 break-all">{quote.signedUserAgent}</p>
                ) : null}
              </div>
            </div>
          ) : null}
