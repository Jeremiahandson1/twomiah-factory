...
export function FinancialsPage() {
  ...
  return (
    <div className="space-y-6">
      <div><h1 className="text-2xl font-bold text-white">Financials</h1><p className="text-slate-400 mt-1">Service call costing and financial management</p></div>
      ...
      <Tabs value={activeTab} onChange={setActiveTab}>
        <TabsList><TabsTrigger value="overview">Overview</TabsTrigger><TabsTrigger value="job-costing">Service Call Costing</TabsTrigger><TabsTrigger value="reports">Reports</TabsTrigger></TabsList>
