...
const SAAS_TIERS: SaaSTier[] = [
  {
    ...
    description: 'Everything you need to run a landscaping business',
    monthly: 49,
    annual: 490,
    bundledWebsite: null,
    heroFeatures: ['Jobs & scheduling', 'Quotes & invoices', 'Payments', 'Customer portal', 'Mobile tech app'],
  ...
  },
  {
    id: 'fleet',
    name: 'Fleet',
    tagline: 'Multi-location dispatch + full website',
    description: 'Multi-location dispatch at scale',
    monthly: 599,
    annual: 5990,
    bundledWebsite: 'book_jobs',
    heroFeatures: ['Multi-location dispatch', 'Advanced scheduling & routing', 'Call tracking & recording', 'Commission tracking', 'Service area pages on website'],
