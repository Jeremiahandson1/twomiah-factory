...
const IMPORT_TYPES = [
  ...
  { id: 'jobs', label: 'Service Calls', icon: Briefcase, description: 'Import work orders and service calls' },
            ...
            {selectedType === 'invoices' && (
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  onChange={(e) => setOptions({ ...options, createMissingContacts: e.target.checked })}
                  className="w-4 h-4 rounded border-gray-300 text-gray-900 dark:border-slate-700 dark:text-slate-100"
                />
