/**
 * {{COMPANY_NAME}} Pricing Configuration — Landscaping
 *
...
export const SELF_HOSTED_PACKAGES = {
  starter: {
    ...
    description: 'Core landscaping CRM for self-hosting',
  ...
  enterprise: {
    ...
    description: 'Full landscaping platform for self-hosting — unlimited users, 3 years updates + support',
