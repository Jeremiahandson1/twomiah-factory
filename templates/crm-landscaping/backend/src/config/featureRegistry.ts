...
export const FEATURE_REGISTRY = {
  ...
  service: {
    ...
    features: {
      ...
      recurring_routes: {
        id: 'recurring_routes',
        name: 'Recurring Route Board',
        description: 'Weekly mow routes grouped into per-day crew routes',
        icon: 'route',
        routes: ['/crm/recurring-routes', '/api/recurring-routes'],
      },
      area_pricing: {
        id: 'area_pricing',
        name: 'Area-Based Pricing',
        description: 'Price services by measured property square footage',
        icon: 'ruler',
        routes: ['/crm/area-pricing', '/api/area-pricing'],
      },
      snow_billing: {
        id: 'snow_billing',
        name: 'Snow & Ice Billing',
        description: 'Per-push, per-event, per-inch, and seasonal snow billing',
        icon: 'snowflake',
        routes: ['/crm/snow-billing', '/api/snow'],
      },
      equipment_tracking: {
