...
import {
  ...
  project, job, changeOrder, changeOrderLineItem, lienWaiver, rfi, submittal, document,
...
export default createPortalRoutes({
  ...
  options: {
    ...
    disable: ['collaborators', 'projects', 'changeOrders', 'selections', 'projectFiles', 'sharedDocuments'],
  },
})
