...
import { FileText, Image as ImageIcon, Settings, Inbox, LogOut, Users, UserCircle, CreditCard, Newspaper, Shield, Globe, BarChart3, Mail, Receipt, Heart, Gift, Package, Clock, CalendarDays } from 'lucide-react'
...
const NAV: NavItem[] = [
  { to: '/sales',    label: 'Sales',    Icon: Receipt,     adminOnly: true },
  { to: '/guests',   label: 'Guests',   Icon: Heart },
  { to: '/gift-cards', label: 'Gift cards', Icon: Gift, adminOnly: true },
  { to: '/inventory', label: 'Inventory', Icon: Package, adminOnly: true },
  { to: '/schedule', label: 'Schedule', Icon: CalendarDays, adminOnly: true },
  { to: '/staff-hours', label: 'Staff hours', Icon: Clock, adminOnly: true },
