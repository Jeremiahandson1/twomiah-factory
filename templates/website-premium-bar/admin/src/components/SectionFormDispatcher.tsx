...
import { FaqAccordionForm } from './sectionForms/FaqAccordionForm'
import { StatsBarForm } from './sectionForms/StatsBarForm'
import { TonightBoardForm } from './sectionForms/TonightBoardForm'
import { MenuSectionsForm, MenuItemHeroForm, EventsRecurringForm } from './sectionForms/BarForms'
import { FramingForm, VisitDetailsForm, PartiesForm, EventsListForm, TapsWallForm } from './sectionForms/BarForms2'
import { TimelineErasForm } from './sectionForms/TimelineErasForm'
import { TimelineEraForm } from './sectionForms/TimelineEraForm'
...
export function SectionFormDispatcher({ type, variant, data, onChange }: Props) {
  ...
  switch (key) {
    ...
    case 'faq/accordion':         return <FaqAccordionForm data={data} onChange={onChange} />
    case 'stats/bar':             return <StatsBarForm data={data} onChange={onChange} />
    case 'tonight/board':         return <TonightBoardForm data={data} onChange={onChange} />
    case 'menu/sections':         return <MenuSectionsForm data={data} onChange={onChange} />
    ...
    case 'parties/inquiry-form':  return <PartiesForm data={data} onChange={onChange} />
    case 'events/list':           return <EventsListForm data={data} onChange={onChange} />
    case 'taps/wall':             return <TapsWallForm data={data} onChange={onChange} />
    default:
      return (
