...
export const SECTION_DEFS: SectionDef[] = [
  ...
  { type: 'timeline', variant: 'book',
    label: 'Timeline — The book (turn the pages)',
    description: 'THE ARCHIVE as an old book: each era is a chapter on a cream spread with a plate, drop cap and page numbers; arrows, keys and the chapter ribbon turn pages. Every chapter is still on the page without JavaScript and has its own URL.',
    defaultData: { eyebrow: '', heading: 'The story', intro: '', asHeading: true, plates: {}, closing: '' } },
  ...
  { type: 'regulars', variant: 'signup',
    label: 'The Regulars — sign-up',
    description: 'Join the Regulars: name and phone (how the bar finds them), optional birthday and email. The email box is never pre-ticked and its exact words are stored with the sign-up. Points terms come from the loyalty settings.',
    defaultData: { heading: 'The Regulars', intro: '', asHeading: true, perks: [] } },
