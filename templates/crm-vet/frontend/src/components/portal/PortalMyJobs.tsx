  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-600 dark:text-slate-400">Jobs assigned to you.</p>
      </div>
      ...
      {jobs.length === 0 ? (
        <div className="bg-white rounded-xl border border-gray-200 p-12 text-center dark:bg-slate-900 dark:border-slate-700">
          ...
          <p className="text-gray-500 dark:text-slate-400">No jobs assigned yet.</p>
        </div>
      ) : (
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div>
      <h2 className="text-lg font-semibold text-gray-900 mb-3 dark:text-slate-100">{title}</h2>
