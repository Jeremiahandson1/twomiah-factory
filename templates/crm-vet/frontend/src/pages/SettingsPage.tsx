...
import { Building2, User, Lock, Users, CreditCard, Plug, Upload, ArrowRightLeft, Calculator, SlidersHorizontal } from 'lucide-react';
        ...
        <div className="w-48 space-y-1">
          ...
          <div className="border-t my-3 pt-3">
            <button onClick={() => navigate('/crm/settings/features')} className="w-full flex items-center gap-3 px-4 py-2 rounded-lg text-left hover:bg-gray-100">
              <SlidersHorizontal className="w-5 h-5" />Features
            </button>
