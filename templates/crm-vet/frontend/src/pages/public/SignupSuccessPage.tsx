    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center dark:bg-slate-900">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-slate-400">Setting up your account...</p>
        </div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 dark:bg-slate-900">
        <div className="bg-white rounded-xl shadow-lg p-8 max-w-md w-full text-center dark:bg-slate-900">
          <div className="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-4">
            <span className="text-red-500 text-2xl">!</span>
          </div>
          <h1 className="text-2xl font-bold text-gray-900 mb-2 dark:text-slate-100">Something went wrong</h1>
          <p className="text-gray-600 mb-6 dark:text-slate-400">{error}</p>
          <Link
            to="/signup"
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900">
      ...
      <main className="max-w-2xl mx-auto px-4 py-16">
        <div className="bg-white rounded-xl shadow-lg p-8 text-center dark:bg-slate-900">
          <div className="w-20 h-20 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6">
            <Check className="w-10 h-10 text-green-500" />
          </div>

          <h1 className="text-3xl font-bold text-gray-900 mb-3 dark:text-slate-100">
            Welcome to {'{{COMPANY_NAME}}'}!
          </h1>
          <p className="text-gray-600 mb-8 text-lg dark:text-slate-400">
            Your account has been created successfully. You're ready to start managing your business.
          </p>

          <div className="bg-gray-50 rounded-lg p-6 mb-8 text-left dark:bg-slate-900">
            <h2 className="font-semibold text-gray-900 mb-4 dark:text-slate-100">What's Next?</h2>
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-gray-900 dark:text-slate-100">Add your first contact</p>
                  <p className="text-sm text-gray-500 dark:text-slate-400">Import your customer list or add contacts manually</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-6 h-6 bg-orange-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div>
                  <p className="font-medium text-gray-900 dark:text-slate-100">Set up your company profile</p>
                  <p className="text-sm text-gray-500 dark:text-slate-400">Add your logo, business hours, and service areas</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-6 h-6 bg-orange-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div>
                  <p className="font-medium text-gray-900 dark:text-slate-100">Create your first job</p>
                  <p className="text-sm text-gray-500 dark:text-slate-400">Schedule work and start tracking your projects</p>
                </div>
              </li>
            </ul>
          </div>
