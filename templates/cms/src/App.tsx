...
// Public site layout
function PublicLayout({ children, onFormSuccess, modalOpen, setModalOpen }: { children: React.ReactNode; onFormSuccess: () => void; modalOpen: boolean; setModalOpen: (open: boolean) => void }) {
  return (
    <>
      <Header />
      <main>{children}</main>
