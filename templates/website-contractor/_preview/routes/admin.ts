...
initFile(homepageFile, {
  hero: {
    tagline: 'Your Trusted Local Roofing & Construction Team',
    title: 'Summit Ridge Builders',
    subtitle: 'Professional Roofing & Construction Services',
    description: 'Serving the Fort Collins area with Quality & Professionalism',
    image: '',
    animation: 'none',
  ...
  ctaSection: {
    ...
    primaryButtonLink: '#contact',
    secondaryButtonText: 'Call (970) 555-0142',
    secondaryButtonLink: 'tel:9705550142',
    backgroundImage: ''
  },
  serviceAreas: ['Fort Collins', 'Loveland', 'Windsor', 'Timnath', 'Greeley'],
  businessHours: {
...
<p>Summit Ridge Builders has been proudly serving the Fort Collins area with professional Roofing & Construction services.</p>
...
<p><strong>Licensed &amp; Insured</strong> - Full protection for your peace of mind.</p>`,
    heroDescription: 'Learn about Summit Ridge Builders and our commitment to quality.',
...
<p>We serve Fort Collins and the surrounding Fort Collins area area.</p>
...
if (!fs.existsSync(settingsFile)) {
  ...
  fs.writeFileSync(settingsFile, JSON.stringify({
    ...
    siteName: 'Summit Ridge Builders',
    companyName: 'Summit Ridge Builders LLC',
    phone: '(970) 555-0142',
    email: 'info@summitridgebuilders.com',
    address: '1420 Riverside Ave',
    city: 'Fort Collins',
    state: 'CO',
    zip: '80524',
    logo: '',
    ...
    defaultMetaTitle: 'Summit Ridge Builders - Roofing & Construction Services in Fort Collins',
    defaultMetaDescription: 'Professional Roofing & Construction services in the Fort Collins area. Contact us today for a free estimate.',
    analytics: {
      googleAnalyticsId: '',
      facebookPixelId: '',
      googleTagManagerId: ''
...
Sitemap: http://localhost:4173/sitemap.xml`,
    emailNotifications: {
      enabled: false,
      recipient: 'info@summitridgebuilders.com',
      smtpHost: '',
      smtpPort: 587,
      smtpUser: '',
      smtpPass: '',
      fromEmail: 'noreply@summitridgebuilders.com',
      fromName: 'Summit Ridge Builders Website',
      sendgridApiKey: ''
    },
...
app.post('/posts', authMiddleware, async (c) => {
  try {
    ...
    const newPost = {
      ...
      author: body.author || 'Summit Ridge Builders',
