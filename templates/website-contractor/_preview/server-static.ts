...
app.get('/', (c) => {
  ...
  return renderPage(c, 'home', {
    ...
    title: settings.seoTitle || settings.companyName || 'Summit Ridge Builders',
...
app.get('/services/:slug', (c) => {
  ...
  if (!service) {
    ...
    service = {
      ...
      description: `Summit Ridge Builders provides expert ${name.toLowerCase()} services throughout Fort Collins area. Contact us today for a free estimate.`,
      icon: 'wrench', image: '',
      features: ['Free estimates', 'Licensed and insured', 'Quality workmanship guarantee', 'Experienced professionals'],
      links: [], offerings: [], faqs: [],
      seoTitle: `${name} | Summit Ridge Builders`,
      seoDescription: `Professional ${name.toLowerCase()} services in Fort Collins, CO by Summit Ridge Builders.`,
  ...
  return renderPage(c, 'service', {
    ...
    title: service.seoTitle || service.name + ' | Summit Ridge Builders',
...
app.get('/service-areas', (c) => {
  ...
  return renderPage(c, 'service-areas-index', {
    areas, services,
    title: 'Areas We Serve | Summit Ridge Builders',
    description: 'Summit Ridge Builders provides professional services throughout Fort Collins area and surrounding communities.',
...
app.get('/service-area/:slug', (c) => {
  ...
  return renderPage(c, 'service-area', {
    ...
    title: `${area.name}, ${area.state} Services | Summit Ridge Builders`,
    description: area.description || `Professional services in ${area.name}, ${area.state} by Summit Ridge Builders.`,
...
app.get('/about', (c) => {
  return renderPage(c, 'about', {
    title: 'About Us | Summit Ridge Builders',
    description: 'Learn about Summit Ridge Builders — serving Fort Collins area with quality craftsmanship.',
...
app.get('/contact', (c) => {
  ...
  return renderPage(c, 'contact', {
    ...
    title: 'Contact Us | Summit Ridge Builders',
...
app.get('/gallery', (c) => {
  ...
  return renderPage(c, 'gallery', {
    gallery,
    title: 'Gallery | Summit Ridge Builders',
...
app.get('/blog', (c) => {
  ...
  return renderPage(c, 'blog', {
    posts,
    title: 'Blog | Summit Ridge Builders',
...
app.get('/blog/:slug', (c) => {
  ...
  return renderPage(c, 'blog-post', {
    post, posts,
    title: post.seoTitle || post.title + ' | Summit Ridge Builders',
...
const TENANT_SLUG = process.env.TENANT_SLUG || 'summit-ridge-builders'
...
app.get('/visualize', (c) => {
  ...
  return renderPage(c, 'visualize', {
    ...
    TENANT_SLUG,
    services,
    title: 'Visualize Your Project | Summit Ridge Builders',
...
app.get('/estimate', (c) => {
  ...
  return renderPage(c, 'estimator', {
    ...
    TENANT_SLUG,
    services,
    title: 'Instant Roof Estimate | Summit Ridge Builders',
