    ...
    <footer className="main-footer">
          ...
          <div className="footer-grid">
            <div className="footer-col about-col">
              <div className="footer-logo">
                ...
                <span>INTEGRITY HOME HEALTHCARE</span>
              </div>
              <p>Quality services for customers throughout the Eau Claire area. Licensed, insured, and committed to excellence.</p>
      ...
      <div className="footer-bottom">
        <div className="container">
          ...
          <p>Serving Eau Claire, Menomonie, Eau Claire, and the Chippewa Valley</p>
        </div>
      </div>
    </footer>
  );
