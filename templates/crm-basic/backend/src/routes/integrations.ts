...
import { createIntegrationsRoutes, createFactoryApiClient } from '../shared/index.ts'
...
export default createIntegrationsRoutes({ db, tables: { company, emailLog }, authenticate, requireAdmin, quickbooks, stripe, factoryApiClient: createFactoryApiClient() })
