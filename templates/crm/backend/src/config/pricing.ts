...
export const SELF_HOSTED_PACKAGES = {
  ...
  enterprise: {
    ...
    description: 'Full platform for self-hosting — unlimited users, 3 years updates + support',
...
export const FEATURE_BUNDLES = {
  ...
  // Twomiah Ads — cross-vertical marketing add-on. Available on every tier
  // across every vertical. Handles Google + Meta ads automation, creative
  // generation, and campaign ROI tracking. Route already exists at /api/ads.
  twomiah_ads: {
    id: 'twomiah_ads',
    name: 'Twomiah Ads',
    description: 'Automated Google + Meta ads — creative, targeting, spend management',
    price: 9900, // $99/mo
    interval: 'month',
    ...
    subFeatures: {
      ...
      campaign_management: { name: 'Automated campaign optimization', price: 1500 },
