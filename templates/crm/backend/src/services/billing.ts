 ...
 * - Stripe integration
 *
 * NOTE: Tables like subscription, billingInvoice, usageRecord, addonPurchase
 * are not in the current Drizzle schema. This service uses raw SQL for those.
 * Add the tables to db/schema.ts for full query-builder support.
 */
