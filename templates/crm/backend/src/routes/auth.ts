...
app.post('/register', async (c) => {
  ...
  // with NO auth, invite, or rate limit — any anonymous visitor could
  // self-provision inside a customer's instance. Users are added by an admin
  // via Settings -> Users. Kept as a 403 stub for any old caller.
