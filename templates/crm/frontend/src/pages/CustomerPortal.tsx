...
export default function CustomerPortal() {
  ...
  // Normalise the configured website: ensure a protocol and a real dotted
  // hostname, so a typo (or a bare word) doesn't render as a live "View website"
  // link that dead-ends.
          ...
          {(products.includes('website') || siteUrl) && (
            siteUrl ? (
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-6 relative overflow-hidden opacity-75">
                ...
                <h3 className="text-lg font-bold text-slate-900 mb-1">Live Website</h3>
                <p className="text-sm text-slate-500">
                  Your website address hasn’t been set yet — add it in Settings.
                </p>
              </div>
            )
          )}
