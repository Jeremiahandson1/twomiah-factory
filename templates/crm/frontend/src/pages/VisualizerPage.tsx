  ...
  if (!hasFeature('visualizer')) {
    return (
      <div className="flex items-center justify-center h-64 flex-col gap-4">
        ...
        <a href="https://twomiah.com/vision" target="_blank" rel="noopener noreferrer" className="text-orange-500 hover:text-orange-600 dark:hover:text-orange-200 font-medium flex items-center gap-1">
