    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="bg-white rounded-lg border overflow-hidden dark:bg-slate-900">
        <table className="w-full">
          ...
          <tbody>
            {forms.length === 0 ? <tr><td colSpan={7} className="px-4 py-12 text-center text-gray-500 dark:text-slate-400">No pay applications yet.</td></tr> :
              forms.map((f) => (
      ...
      {showCreate && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50 overflow-auto">
          <div className="bg-white rounded-xl w-full max-w-4xl p-6 my-8 dark:bg-slate-900">
