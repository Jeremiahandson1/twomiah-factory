...
export default function SchedulePage() {
  ...
  // tenant without the feature was still handed 36 draggable jobs and the "Drag a service call to another
  ...
  return <SharedSchedulePage api={api as any} toast={toast} config={{ dragDrop: hasFeature('drag_drop_calendar') }} />;
}
