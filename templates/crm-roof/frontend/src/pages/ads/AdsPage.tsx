            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between mt-3">
                  ...
                  {ad.status === 'active' && (
                    <button className="text-xs text-gray-500 dark:text-slate-400 hover:text-yellow-500 dark:hover:text-yellow-300 flex items-center gap-1">
                      <Pause className="w-3 h-3" /> Pause
                    </button>
                  )}
                  {ad.status === 'paused' && (
                    <button className="text-xs text-gray-500 dark:text-slate-400 hover:text-green-500 dark:hover:text-green-300 flex items-center gap-1">
