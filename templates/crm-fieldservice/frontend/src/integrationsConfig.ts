...
export const importConfig: ImportConfig = {
    types: [
      ...
      { id: 'jobs', label: 'Service Calls', description: 'Import work orders and service calls', feature: 'jobs' },
...
export const migrationConfig: MigrationConfig = { entityLabels: { jobs: 'Service Calls & Work Orders' } }
