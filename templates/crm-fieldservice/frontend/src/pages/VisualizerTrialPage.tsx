  ...
  const handleStartTrial = async () => {
    ...
    try {
      await api.post('/api/support/tickets', {
        subject: 'Exterior Visualizer — 14-Day Free Trial Request',
        description: `${company?.name || 'Customer'} is requesting a 14-day free trial of the Exterior Visualizer add-on.`,
