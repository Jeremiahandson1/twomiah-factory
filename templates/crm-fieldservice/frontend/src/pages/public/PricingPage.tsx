...
const FEATURES = {
  core: {
    ...
    items: [
      ...
      { name: 'Service Calls / Work Orders', starter: true, pro: true, business: true, construction: true },
  ...
  field: {
    ...
    items: [
      ...
      { name: 'Service Call Costing Reports', starter: false, pro: true, business: true, construction: true },
    ],
  },
  operations: {
    name: 'Operations',
