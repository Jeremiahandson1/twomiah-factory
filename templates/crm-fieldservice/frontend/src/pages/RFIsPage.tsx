  ...
  return (
    <div>
      ...
      <Modal isOpen={respondOpen} onClose={() => setRespondOpen(false)} title="Respond to RFI" size="md">
        <div className="space-y-4">
          <div className="p-3 bg-gray-50 rounded-lg dark:bg-slate-900"><p className="font-medium">{respondRfi?.subject}</p><p className="text-sm text-gray-600 mt-1 dark:text-slate-400">{respondRfi?.question}</p></div>
