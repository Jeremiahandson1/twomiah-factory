...
export const FEATURE_CATEGORIES = [
  ...
  {
    id: 'job_execution',
    name: 'Service Call Execution & Field Work',
    icon: 'Wrench',
    ...
    features: [
      ...
      { id: 'job_forms', name: 'Service Call Forms & Checklists', description: 'Custom forms and checklists for service call completion' },
  ...
  },
  {
    ...
    features: [
      ...
      { id: 'client_history', name: 'Client Service History', description: 'View complete service history for each client' },
  ...
  },
  {
    ...
    icon: 'PieChart',
    description: 'Service call costing and financial tracking',
    features: [
      { id: 'job_costing', name: 'Service Call Costing', description: 'Track all costs against service calls for profitability' },
      { id: 'profit_bar', name: 'Service Call Profit Bar / Margin View', description: 'Visual profit margin display on each service call' },
  ...
  },
  {
    ...
    features: [
      ...
      { id: 'job_checklists_training', name: 'Service Call Checklists for Training', description: 'Training checklists for new technicians' },
    ]
  },
  {
    id: 'platform',
