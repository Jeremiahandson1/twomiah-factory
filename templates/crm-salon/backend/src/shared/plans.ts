// The salon modules. These are what this CRM actually IS, so they belong in
// every tier — a salon on the cheapest plan still needs the book and the chart.
//
...
// these ids in the fallback, that path would hand a salon the contractor
// starter set and hide the entire salon sidebar.
const SALON_CORE = [
  'client_profiles', 'service_menu', 'salon_booking', 'rebooking_reminders', 'salon_memberships',
]
