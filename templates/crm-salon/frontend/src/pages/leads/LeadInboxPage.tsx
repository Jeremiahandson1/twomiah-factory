...
const SOURCE_COLORS: Record<string, { bg: string; text: string; label: string }> = {
  google_business: { bg: '#fce4ec', text: '#c62828', label: 'Google' },
  instagram: { bg: '#f3e5f5', text: '#6a1b9a', label: 'Instagram / Facebook' },
  yelp: { bg: '#fff3e0', text: '#e65100', label: 'Yelp' },
  booking_app: { bg: '#e3f2fd', text: '#1565c0', label: 'Booking app' },
  website: { bg: '#e8f5e9', text: '#2e7d32', label: 'Website' },
