              ...
              {clients.map((c) => (
                <tr key={c.id} className="hover:bg-gray-50 dark:hover:bg-slate-800">
                  ...
                  <td className="px-4 py-3 text-gray-600 dark:text-slate-400">
                    ...
                    {c.email && <div className="text-xs text-gray-500 dark:text-slate-400">{c.email}</div>}
                  </td>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1 dark:text-slate-200">
                Allergies / sensitivities <span className="text-xs text-gray-500 dark:text-slate-400">(shown as a red banner on the chart)</span>
              </label>
