...
const INTEGRATIONS: Integration[] = [
  ...
  // Jobber import + Angi/Thumbtack/Google-LSA lead sources removed — those are
  // field-service concepts, not salon integrations. (FIT-01)
  {
    id: 'stripe',
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-orange-50 dark:from-slate-950 dark:to-slate-900 flex flex-col">
      ...
      <div className="flex-1 flex items-start justify-center px-4 py-8">
        <div className="w-full max-w-2xl">
          ...
          {currentStep === 2 && <EmailAliasesStep productId="crm-salon" defaultForwardTo={profile.email} onBack={handleBack} onNext={handleNext} />}
