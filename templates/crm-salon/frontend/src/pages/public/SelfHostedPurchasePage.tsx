              ...
              <div className="space-y-3">
                {licenses.map((license: Record<string, unknown>) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div>
                        <span className="font-semibold text-gray-900 dark:text-slate-100">{license.name as string}</span>
              ...
              <div className="space-y-3">
                {addons.map((addon: Record<string, unknown>) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div>
                        <span className="font-semibold text-gray-900 dark:text-slate-100">{addon.name as string}</span>
                        {!!addon.recurring && (
            ...
            <div className="bg-white rounded-xl border p-6 sticky top-6 dark:bg-slate-900">
              ...
              <div className="space-y-3 mb-6">
                <div className="flex justify-between">
                  <span className="text-gray-600 dark:text-slate-400">{selectedLicenseData?.name as string}</span>
                ...
                {selectedAddons.map((addonId: string) => {
                  ...
                  return (
                    <div key={addonId} className="flex justify-between text-sm">
                      <span className="text-gray-600 dark:text-slate-400">{addon?.name as string}</span>
