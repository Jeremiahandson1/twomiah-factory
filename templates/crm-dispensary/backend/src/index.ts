...
// A module switched off is refused at the API, not merely hidden in the menu. The nav has gated these
// families for a long time and the routes never were: with digital_signage, curbside and training_lms
// all off, the sidebar items vanished and the pages said "isn't part of this CRM" while
// /api/signage/screens, /api/curbside/stats and /api/training/courses each answered 200 with real data.
// A UI that hides a page the API still serves is a paywall made of CSS. (Dispensary T29 M5)
//
// The list mirrors AppLayout.tsx route for route, and check-dispensary-api-gates.ts fails the build if
...
app.use('/api/locations/*', authenticate, requireEnabledFeature('multi_location'))
app.use('/api/rfid', authenticate, requireEnabledFeature('rfid'))
app.use('/api/rfid/*', authenticate, requireEnabledFeature('rfid'))
app.use('/api/labels', authenticate, requireEnabledFeature('labels'))
app.use('/api/labels/*', authenticate, requireEnabledFeature('labels'))
app.use('/api/metrc', authenticate, requireEnabledFeature('metrc'))
app.use('/api/metrc/*', authenticate, requireEnabledFeature('metrc'))
app.use('/api/compliance', authenticate, requireEnabledFeature('compliance'))
app.use('/api/compliance/*', authenticate, requireEnabledFeature('compliance'))
app.use('/api/documents', authenticate, requireEnabledFeature('documents'))
app.use('/api/documents/*', authenticate, requireEnabledFeature('documents'))
app.use('/api/referrals', authenticate, requireEnabledFeature('referrals'))
app.use('/api/referrals/*', authenticate, requireEnabledFeature('referrals'))
app.use('/api/recommendations', authenticate, requireEnabledFeature('ai_recommendations'))
app.use('/api/recommendations/*', authenticate, requireEnabledFeature('ai_recommendations'))
app.use('/api/merch', authenticate, requireEnabledFeature('merch_store'))
app.use('/api/merch/*', authenticate, requireEnabledFeature('merch_store'))
app.use('/api/delivery', authenticate, requireEnabledFeature('delivery'))
app.use('/api/delivery/*', authenticate, requireEnabledFeature('delivery'))
app.use('/api/tracking', authenticate, requireEnabledFeature('delivery_tracking'))
app.use('/api/tracking/*', authenticate, requireEnabledFeature('delivery_tracking'))
app.use('/api/cultivation', authenticate, requireEnabledFeature('cultivation'))
app.use('/api/cultivation/*', authenticate, requireEnabledFeature('cultivation'))
app.use('/api/manufacturing', authenticate, requireEnabledFeature('manufacturing'))
app.use('/api/manufacturing/*', authenticate, requireEnabledFeature('manufacturing'))
app.use('/api/wholesale', authenticate, requireEnabledFeature('wholesale'))
app.use('/api/wholesale/*', authenticate, requireEnabledFeature('wholesale'))
...
app.use('/api/gamified-loyalty/*', authenticate, requireEnabledFeature('gamified_loyalty'))
app.use('/api/seo-pages', authenticate, requireEnabledFeature('seo_pages'))
app.use('/api/seo-pages/*', authenticate, requireEnabledFeature('seo_pages'))
...
app.use('/api/grow-inputs/*', authenticate, requireEnabledFeature('cultivation'))
app.use('/api/scheduling', authenticate, requireEnabledFeature('scheduling'))
app.use('/api/scheduling/*', authenticate, requireEnabledFeature('scheduling'))
app.use('/api/training', authenticate, requireEnabledFeature('training_lms'))
app.use('/api/training/*', authenticate, requireEnabledFeature('training_lms'))
app.use('/api/fraud-detection', authenticate, requireEnabledFeature('fraud_detection'))
app.use('/api/fraud-detection/*', authenticate, requireEnabledFeature('fraud_detection'))
app.use('/api/approvals', authenticate, requireEnabledFeature('approvals'))
app.use('/api/approvals/*', authenticate, requireEnabledFeature('approvals'))
app.use('/api/offline', authenticate, requireEnabledFeature('offline_mode'))
app.use('/api/offline/*', authenticate, requireEnabledFeature('offline_mode'))
