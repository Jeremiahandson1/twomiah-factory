...
interface Integration {
  ...
  label: string;
  description: string;
  category: 'dns' | 'pos_import' | 'compliance' | 'listing' | 'accounting' | 'payments' | 'communication';
  guideSteps: string[];
  externalUrl?: string;
...
const INTEGRATIONS: Integration[] = [
  ...
  {
    id: 'dutchie',
    label: 'Dutchie POS Import',
    description: 'Export product and customer data from Dutchie and import CSVs into your CRM.',
    category: 'pos_import',
    guideSteps: [
  ...
  {
    id: 'metrc',
    label: 'METRC / BioTrack Compliance',
    description: 'Connect your state seed-to-sale tracking system for compliance reporting.',
    category: 'compliance',
    guideSteps: [
      'Obtain your API credentials from your state METRC or BioTrack portal',
      'Go to Settings > Integrations > Compliance in your CRM',
      'Enter your API key, User key, and select your state',
      'Test the connection — your CRM will sync package and transfer data automatically',
    ],
  },
  {
    id: 'leafly_weedmaps',
    label: 'Leafly / Weedmaps Listing',
    description: 'Sync your menu and product data to Leafly and Weedmaps.',
    category: 'listing',
    guideSteps: [
      'Go to Settings > Integrations > Listings in your CRM',
      'Connect your Leafly account by entering your Leafly API key (found in Leafly Biz dashboard)',
      'Connect your Weedmaps account by entering your Weedmaps API key (found in Weedmaps Admin)',
      'Enable menu sync — product names, prices, and availability will stay up to date automatically',
    ],
  },
  {
    id: 'quickbooks',
...
const CATEGORY_LABELS: Record<string, string> = {
  ...
  listing: 'Online Listings',
  accounting: 'Accounting',
  payments: 'Payments',
  communication: 'Communication',
};

const CATEGORY_ORDER = ['dns', 'pos_import', 'compliance', 'listing', 'accounting', 'payments', 'communication'];
