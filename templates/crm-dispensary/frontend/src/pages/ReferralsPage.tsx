            ...
            <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100 dark:bg-slate-900">
              <div className="space-y-5">
                ...
                <label className="flex items-center justify-between cursor-pointer">
                  <div>
                    <p className="font-medium text-gray-900 dark:text-slate-100">Enable Referral Program</p>
                    <p className="text-sm text-gray-500 dark:text-slate-400">Allow customers to refer friends and earn rewards</p>
                  </div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-1 dark:text-slate-400">0 = unlimited</p>
                  </div>
                </div>
              </div>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b bg-gray-50 dark:bg-slate-900">
                      <th className="text-left px-4 py-3 font-medium text-gray-700 dark:text-slate-200">Referrer</th>
                      <th className="text-left px-4 py-3 font-medium text-gray-700 dark:text-slate-200">Referred</th>
                      <th className="text-left px-4 py-3 font-medium text-gray-700 dark:text-slate-200">Code</th>
                      <th className="text-left px-4 py-3 font-medium text-gray-700 dark:text-slate-200">Status</th>
                      <th className="text-left px-4 py-3 font-medium text-gray-700 dark:text-slate-200">Created</th>
                      <th className="text-left px-4 py-3 font-medium text-gray-700 dark:text-slate-200">Rewarded</th>
                      <th className="text-right px-4 py-3 font-medium text-gray-700 dark:text-slate-200">Actions</th>
                    </tr>
                  </thead>
                ...
                <div className="bg-white rounded-lg shadow-sm p-5 border border-gray-100 dark:bg-slate-900">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold text-gray-900 dark:text-slate-100">{stats.totalReferrals ?? 0}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-sm p-5 border border-gray-100 dark:bg-slate-900">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold text-gray-900 dark:text-slate-100">{stats.conversionRate ?? 0}%</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-sm p-5 border border-gray-100 dark:bg-slate-900">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold text-gray-900 dark:text-slate-100">{stats.rewardsIssued ?? 0}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-100 dark:bg-slate-900">
                ...
                <div className="divide-y">
                  {(stats.topReferrers || []).map((referrer: any, idx: number) => (
                    <div key={referrer.id || idx} className="px-5 py-4 flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        <p className="font-medium text-gray-900 dark:text-slate-100">{referrer.name || 'Unknown'}</p>
                        <p className="text-sm text-gray-500 dark:text-slate-400">{referrer.email || ''}</p>
                      </div>
                  ...
                  {(!stats.topReferrers || stats.topReferrers.length === 0) && (
                    <div className="px-5 py-8 text-center text-gray-500 dark:text-slate-400">
