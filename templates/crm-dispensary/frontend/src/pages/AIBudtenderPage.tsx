                ...
                <div key={i}>
                  {msg.role === 'user' ? (
                    <div className="flex justify-end">
                      <div className="bg-green-700 text-white rounded-lg p-3 max-w-[80%]">
                              ...
                              <div key={j} className="bg-white rounded-lg p-3 shadow-sm border border-green-100 dark:bg-slate-900">
                                <div className="flex items-start justify-between">
                                  ...
                                  <button
                                    ...
                                    className="px-2 py-1 text-xs bg-green-700 text-white rounded hover:bg-green-800 flex items-center gap-1"
                                  >
