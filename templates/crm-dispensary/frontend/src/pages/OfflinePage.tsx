    ...
    <div>
      ...
      {tab === 'status' && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-white border rounded-lg p-5 dark:bg-slate-900">
            <div className="flex items-center justify-between mb-3">
              <span className="text-sm text-gray-500 dark:text-slate-400">Last Sync</span>
          ...
          {loading ? (
            ...
            <div className="bg-white border rounded-lg p-6 space-y-5 dark:bg-slate-900">
              ...
              <div>
                ...
                <div className="text-sm text-gray-500 mb-2 dark:text-slate-400">Maximum offline transactions to store</div>
              ...
              <div>
                ...
                <div className="text-sm text-gray-500 mb-2 dark:text-slate-400">How often to retry failed syncs</div>
                  ...
                  {[
                    ...
                    <label key={feature.key} className="flex items-center justify-between cursor-pointer">
                      <div>
                        ...
                        <div className="text-xs text-gray-500 dark:text-slate-400">{feature.desc}</div>
                      </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-gray-50 dark:bg-slate-900">
                    ...
                    <th className="px-4 py-3 text-left text-sm font-medium text-gray-600 dark:text-slate-400">Retries</th>
                    <th className="px-4 py-3 text-left text-sm font-medium text-gray-600 dark:text-slate-400">Error</th>
      ...
      {tab === 'instructions' && (
        <div className="max-w-2xl">
          <div className="bg-white border rounded-lg p-6 space-y-6 dark:bg-slate-900">
            <div>
