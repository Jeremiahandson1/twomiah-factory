...
// Checkout session for the standalone website — pricing model v2: flat
// $49/mo, no build fee (STRIPE_PRICE_V2_WEBSITE) — marks the tenant's
// products to include 'website-premium' so the eventual deploy picks the
// right template, and returns the Stripe URL the prospect's browser
// redirects to.
//
