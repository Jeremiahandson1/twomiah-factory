// Renders the showcase template's hand-authored sample compositions.
//
// Run from apps/api:
//   bun run scripts/render-premium-showcase-samples.ts
import fs from 'fs'
import path from 'path'
import ejs from 'ejs'

const ROOT = path.resolve(__dirname, '../../../templates/website-premium-showcase')
