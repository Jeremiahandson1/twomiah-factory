/**
 * Tears down a tenant provisioned by scripts/provision-fieldservice-test.ts — deletes the
...
if (!tenantId) {
  console.error('Usage: bun run scripts/cleanup-fieldservice-test.ts <tenantId>')
  process.exit(1)
}
