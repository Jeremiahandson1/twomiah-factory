// Renders the homecare template's two hand-authored sample compositions
// so they can be opened side-by-side with the other premium templates
// to confirm visual differentiation.
//
// Run from apps/api:
//   bun run scripts/render-premium-homecare-samples.ts
import fs from 'fs'
import path from 'path'
import ejs from 'ejs'

const ROOT = path.resolve(__dirname, '../../../templates/website-premium-homecare')
