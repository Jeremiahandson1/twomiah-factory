// Renders the dispensary template's hand-authored sample compositions.
//
// Run from apps/api:
//   bun run scripts/render-premium-dispensary-samples.ts
import fs from 'fs'
import path from 'path'
import ejs from 'ejs'

const ROOT = path.resolve(__dirname, '../../../templates/website-premium-dispensary')
