/**
 * Tears down a tenant provisioned by scripts/provision-salon-pair-test.ts — deletes the
...
if (!tenantId) {
  console.error('Usage: bun run scripts/cleanup-salon-pair-test.ts <tenantId>')
  process.exit(1)
}
