...
const INTEGRATIONS = [
  ...
  { id: 'googleMaps' as const, name: 'Google Maps — GPS, Geocoding & Solar', icon: '🗺️', color: '#4285F4', requiredFeatures: ['gps_tracking', 'routing', 'maps', 'instant_estimator'], description: 'Powers GPS tracking, route optimization, map views, and the instant roof estimator (Solar API).', link: 'https://console.cloud.google.com/apis/credentials', linkText: 'console.cloud.google.com', fields: [{ key: 'apiKey', label: 'API Key', placeholder: 'AIzaSy...', sensitive: false }] },
  ...
  { id: 'nearmap' as const, name: 'Nearmap — High-Res Aerial Imagery & AI', icon: '🛰️', color: '#00A3E0', requiredFeatures: ['instant_estimator', 'roof_reports'], description: 'Powers 5-7cm aerial imagery, AI roof detection (material, condition, edges), and DSM elevation data. Falls back to Google Solar without this.', link: 'https://app.nearmap.com', linkText: 'app.nearmap.com', fields: [{ key: 'apiKey', label: 'API Key', placeholder: 'your-nearmap-api-key', sensitive: true }] },
  { id: 'replicate' as const, name: 'Replicate — AI Segmentation (SAM 2)', icon: '🤖', color: '#0B0F19', requiredFeatures: ['instant_estimator', 'roof_reports'], description: 'Fallback AI roof segmentation when Nearmap AI is unavailable. Uses Meta SAM 2 model. Not needed if Nearmap is configured.', link: 'https://replicate.com/account/api-tokens', linkText: 'replicate.com', fields: [{ key: 'apiToken', label: 'API Token', placeholder: 'r8_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', sensitive: true }] },
]
